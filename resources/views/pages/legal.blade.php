...
.legal-card { max-width: 800px; margin: 0 auto; background: var(--white); border-radius: var(--radius-xl); padding: 3rem 3rem; box-shadow: var(--shadow); border: 1px solid var(--gray-100); }
.legal-card h1 { font-size: 1.75rem; font-weight: 800; color: var(--gray-900); margin-bottom: .75rem; }
.legal-meta { font-size: .82rem; color: var(--gray-400); margin-bottom: 2rem; padding-bottom: 1.5rem; border-bottom: 1px solid var(--gray-100); }
...
.legal-nav { display: flex; gap: 1rem; margin-top: 2rem; padding-top: 1.5rem; border-top: 1px solid var(--gray-100); flex-wrap: wrap; }
