...
.about-hero .accent-line { width: 48px; height: 3px; background: linear-gradient(135deg, var(--primary), #8b5cf6); border-radius: 4px; margin: .75rem auto 1.25rem; }
.about-hero p { color: var(--gray-500); font-size: 1.05rem; max-width: 520px; margin: 0 auto; line-height: 1.7; }
.about-card { max-width: 800px; margin: 0 auto; background: var(--white); border-radius: var(--radius-xl); padding: 3rem; box-shadow: var(--shadow); border: 1px solid var(--gray-100); }
