...
.form-group input { width: 100%; padding: .75rem 1rem; border: 1px solid var(--gray-200); border-radius: var(--radius); font-size: .95rem; color: var(--gray-800); transition: var(--transition); }
...
.btn-submit { width: 100%; padding: .9rem; background: linear-gradient(135deg, var(--primary), #8b5cf6); color: var(--white); font-weight: 700; font-size: 1rem; border: none; border-radius: var(--radius); cursor: pointer; transition: var(--transition); margin-top: .5rem; }
.btn-submit:hover { opacity: .92; transform: translateY(-1px); }
.btn-submit:disabled { opacity: .5; cursor: not-allowed; transform: none; }
.expiry-notice { display: flex; align-items: center; gap: .5rem; margin-top: 1rem; padding: .85rem; background: #fffbeb; border: 1px solid #fde68a; border-radius: var(--radius); font-size: .82rem; color: #92400e; }
...
<div class="checkout-page">
    <div class="container">
        ...
        <form method="POST" action="{{ route('checkout.submit') }}" id="checkoutForm" style="margin-top:1.5rem;">
            ...
            @if(session('error'))
            <div class="expiry-notice" style="background:#fef2f2;border-color:#fecaca;color:#b91c1c;margin-bottom:1.25rem;">
            ...
            <div class="checkout-grid">
                <div>
                    ...
                    <div class="checkout-card" style="margin-bottom:1.25rem;">
                        ...
                        <div class="expiry-notice" style="background:#fef2f2;border-color:#fecaca;color:#b91c1c;">
...
(function(){
    ...
    var countdown=setInterval(function(){
        remaining--;
        if(remaining<=0){clearInterval(countdown);timerEl.textContent='Expired';timerEl.style.color='#ef4444';return;}
