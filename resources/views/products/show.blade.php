...
.product-image { width: 100%; aspect-ratio: 4/3; border-radius: var(--radius-xl); overflow: hidden; background: var(--gray-100); box-shadow: var(--shadow-md); }
...
.product-discount-tag { background: #fef2f2; color: #ef4444; font-size: .82rem; font-weight: 700; padding: .25rem .7rem; border-radius: 50px; }
...
.product-status.available { background: #ecfdf5; color: #059669; }
.product-status.unavailable { background: #fef2f2; color: #dc2626; }
...
.btn-buy { flex: 1; padding: .9rem 1.5rem; background: linear-gradient(135deg, var(--primary), #8b5cf6); color: var(--white); font-weight: 700; font-size: 1rem; border: none; border-radius: var(--radius); cursor: pointer; text-align: center; transition: var(--transition); text-decoration: none; display: flex; align-items: center; justify-content: center; gap: .5rem; }
.btn-buy:hover { opacity: .92; transform: translateY(-1px); color: var(--white); }
...
.no-reviews { color: var(--gray-400); font-size: .9rem; padding: 1.5rem; text-align: center; background: var(--gray-50); border-radius: var(--radius); }
...
.review-form .form-group input[type="text"], .review-form .form-group textarea { width: 100%; padding: .75rem 1rem; border: 1px solid var(--gray-200); border-radius: var(--radius); font-size: .95rem; color: var(--gray-800); font-family: inherit; transition: var(--transition); }
.review-form .form-group textarea { min-height: 110px; resize: vertical; }
.review-form .form-group input[type="text"]:focus, .review-form .form-group textarea:focus { outline: none; border-color: var(--primary); box-shadow: 0 0 0 3px rgba(99,102,241,.12); }
.star-rating { display: flex; flex-direction: row-reverse; justify-content: flex-end; gap: .15rem; }
.star-rating input { display: none; }
.star-rating label { font-size: 1.7rem; color: #d1d5db; cursor: pointer; line-height: 1; transition: var(--transition); }
.star-rating label:hover, .star-rating label:hover ~ label, .star-rating input:checked ~ label { color: #f59e0b; }
.review-success { display: flex; align-items: center; gap: .5rem; padding: .85rem 1rem; background: #ecfdf5; border: 1px solid #a7f3d0; border-radius: var(--radius); color: #047857; font-size: .9rem; font-weight: 600; margin-bottom: 1rem; }
.form-error { color: #ef4444; font-size: .8rem; margin-top: .3rem; }
.review-submit { padding: .85rem 2rem; background: linear-gradient(135deg, var(--primary), #8b5cf6); color: var(--white); font-weight: 700; font-size: .95rem; border: none; border-radius: var(--radius); cursor: pointer; transition: var(--transition); }
.review-submit:hover { opacity: .92; transform: translateY(-1px); }
                ...
                <div class="product-image">
                    ...
                    @else
                        <div class="product-placeholder">
                            <svg width="80" height="80" fill="none" stroke="#d1d5db" stroke-width="1.5"><rect x="8" y="8" width="64" height="64" rx="8"/><circle cx="28" cy="28" r="10"/><path d="M8 56l20-20 16 16 10-10 18 18"/></svg>
                        </div>
                    @endif
                </div>
            </div>
